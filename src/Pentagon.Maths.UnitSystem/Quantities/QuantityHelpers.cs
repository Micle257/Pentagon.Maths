...
namespace Pentagon.Maths.Quantities
{
    ...
    /// <summary>
    ///     Provides helper methods for <see cref="IPhysicalQuantity" />.
    /// </summary>
    public static class QuantityHelpers
    {
        /// <summary>
        ///     Compares two <see cref="IPhysicalQuantity" /> over a reference <see cref="IPhysicalUnit" />.
        /// </summary>
        ...
        /// <summary>
        ///     Determines whether two <see cref="IPhysicalQuantity" /> are equal.
        /// </summary>
        /// <typeparam name="TQuantity"> The type of the quantity. </typeparam>
        /// <typeparam name="TUnit"> The type of the unit. </typeparam>
        /// <param name="first"> The first quantity. </param>
        ...
        /// <param name="referenceUnit"> The reference unit. </param>
        /// <returns>
        ///     <c> true </c> if the quantities are equal; otherwise, <c> false </c>.
        /// </returns>
